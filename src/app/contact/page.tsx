            ...
            <div className={styles.infoCol}>
              ...
              <div className={styles.infoCard}>
                ...
                <div>
                  ...
                  <a href="tel:+918626983777" className={styles.infoLink}>+91 86269 83777</a>
                </div>
              </div>
              ...
              <div className={styles.infoCard}>
                ...
                <div>
                  ...
                  <a href="mailto:info@thedivinehima.com" className={styles.infoLink}>info@thedivinehima.com</a>
                </div>
              </div>
